...
export type TestPlanCapability = Schemas['TestPlanCapability'];
export type TestPlanRequirement = Schemas['TestPlanRequirement'];
export type TestDataRequirementView = Schemas['TestDataRequirementView'];
export type DocRole = Schemas['DocRole'];
